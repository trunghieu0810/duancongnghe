...
<!-- /WhatsHelp.io widget -->
        <div class="container-fluid py-4 bg-white">
             <div class="container py-4">
                    <h2  class="text-center">CHÀO MỪNG BẠN ĐẾN VỚI TANMINH </h2>
                 <div class="row py-4">
                     <div class="col-md-6">
         ...
         <div class="container-fluid py-4" style="background: #f7f7f7;">
                <div class="container py-4">
                       <h2  class="text-center">GIẢNG VIÊN TANMINH </h2>
                    <div class="row py-4">
            ...
            <div class="container-fluid py-4 bg-white">
                    <div class="container py-4">
                        <h2 class="text-center">KHÓA HỌC TANMINH MỚI</h2>
                            <div class="row my-4">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <p><i>Hãy để lại thông tin của bạn, TANMINH sẽ giúp xây dựng lộ trình Anh ngữ tốt nhất dành riêng cho bạn.</i></p>
                                <?php  
                                echo $page['video'];
                                ?>

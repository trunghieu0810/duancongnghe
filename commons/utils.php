<?php 
    ...
    define('SITE_URL','http://localhost/pro1013/');
    
    $ADMIN_URL = "http://localhost/pro1013/admin/";
    $AP_URL = "http://localhost/pro1013/ap/";
    $ADMIN_ASSET_URL = "http://localhost/pro1013/admin/adminlte/";

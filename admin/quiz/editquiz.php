...
$quiz = getSimpleQuery($listQQuery);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Sửa bài quiz</li>
      </ol>
    </section>

    <!-- Main content -->
    <section class="content">
      <form action="<?= $ADMIN_URL ?>quiz/save_editquiz.php" method="post">
      <div class="box">
        <div class="box-header">
                <h3 class="box-title">Sửa bài quiz</h3>
        </div>
              <!-- /.box-header -->
        <div class="box-body">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" value="<?php echo $quiz['name']; ?>">
            <?php 
              if(isset($_GET['n'])){
                ?>
            ...
            <select class="form-control" name="course_id" id="course_id">
                <option value="0">--Chọn khóa học--</option>
                                                <?php foreach($cates as $row){ ?>
                                                    <option 
                                                    <?php echo $row['id'] == $quiz['course_id'] ? "selected" : "" ?>
